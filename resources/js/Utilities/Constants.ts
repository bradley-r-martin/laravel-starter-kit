...
export const ADDRESS_FORMAT =
    /^([a-zA-Z0-9]*[^unit]\s\s*\d[a-zA-Z0-9]*-*[a-zA-Z0-9]*)\s*([a-zA-Z0-9_ ]*)$/i;
...
export const COUNTRY = [
    ...
    {
        label: 'The Republic of South Korea',
        value: 'The Republic of South Korea',
    },
...
export const STREET_SUFFIX_MAPPING = {
    CN: 'Central',
    CENTRAL: 'Central',
    E: 'East',
    EAST: 'East',
...
export const STREET_TYPE_MAPPING = {
    ACCESS: 'Access',
    ACCS: 'Access',
    ALLEY: 'Alley',
    ALLEYWAY: 'Alleyway',
